...
public class Query {
	...
	/**
	 * Cr�e une instance de query bas� sur une string bien format� de query rdf
	 * @param query une chaine de pr�f�rence SELECT '[selection]' WHERE { [condition1] . [condition2]}  
	 */
	...
	/**
	 * Retourne une liste non modifiable correspondant � la selection
